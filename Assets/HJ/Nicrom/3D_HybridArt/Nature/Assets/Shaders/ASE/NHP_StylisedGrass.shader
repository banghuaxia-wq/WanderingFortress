	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_MainTex187 = input.ase_texcoord6.xy;
				float4 tex2DNode187 = tex2D( _MainTex, uv_MainTex187 );
				float MainTextureColor193 = tex2DNode187.r;
				float2 texCoord172 = input.ase_texcoord6.xy * float2( 1,1 ) + float2( 0,0 );
...
Node;AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;106;1955.348,-807.6854;Inherit;False;205;Opacity;1;0;OBJECT;;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=4616A9C2A6C348EB547CA5793AC703E51851B53F