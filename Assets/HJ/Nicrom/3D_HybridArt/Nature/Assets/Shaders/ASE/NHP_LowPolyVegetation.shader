	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float DB_VerticalMaxLength165 = _DBVerticalMaxLength;
				float3 rotatedValue29_g94 = RotateAroundAxis( PivotPosOnYAxis56_g94, input.positionOS.xyz, DB_RotationAxis173, radians( ( ( ( DB_VerticalAmplitude166 + ( DB_VerticalAmplitudeOffset169 * ( 1.0 - PhaseShift48_g94 ) ) ) * sin( ( ( ( ( _TimeParameters.x ) * Fequency45_g94 ) - ( ( 2.0 * PI ) * PhaseShift48_g94 ) ) + ( ( ( objToWorld59_g94.x + objToWorld59_g94.z ) + ( ( _TimeParameters.x ) * Fequency45_g94 ) ) * DB_VerticalPhase162 ) ) ) ) * ( distance( input.positionOS.xyz , PivotPosOnYAxis56_g94 ) / DB_VerticalMaxLength165 ) ) ) );
				float VerticalBendingMask172 = step( 1.0 , input.texcoord0.y );
				float3 DB_VerticalMovement202 = ( ( rotatedValue29_g94 - input.positionOS.xyz ) * VerticalBendingMask172 );
				#ifdef _ENABLEVERTICALBENDING_ON
				float3 staticSwitch235 = DB_VerticalMovement202;
				#else
				...
				float DB_HorizontalMaxRadius175 = _DBHorizontalMaxRadius;
				float3 rotatedValue33_g93 = RotateAroundAxis( PivotPoint49_g93, input.positionOS.xyz, float3( 0, 1, 0 ), radians( ( ( DB_HorizontalAmplitude174 * sin( ( ( ( ( _TimeParameters.x ) * Frequency41_g93 ) - ( ( 2.0 * PI ) * ( 1.0 - DB_PhaseShift170 ) ) ) + ( ( ( objToWorld53_g93.x + objToWorld53_g93.z ) + ( ( _TimeParameters.x ) * Frequency41_g93 ) ) * DB_HorizontalPhase167 ) ) ) ) * ( distance( input.positionOS.xyz , appendResult20_g93 ) / DB_HorizontalMaxRadius175 ) ) ) );
				float HorizontalBendingMask164 = step( 1.0 , input.texcoord0.x );
				float3 DB_SideToSideMovement201 = ( ( rotatedValue33_g93 - input.positionOS.xyz ) * HorizontalBendingMask164 );
				#ifdef _ENABLEHORIZONTALBENDING_ON
				float3 staticSwitch237 = DB_SideToSideMovement201;
				#else
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;264;507.0764,-829.7026;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;SceneSelectionPass;0;8;SceneSelectionPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=SceneSelectionPass;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;265;507.0764,-829.7026;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ScenePickingPass;0;9;ScenePickingPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Picking;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=5525EE760AE2016E852600EB66FBE31BB94FECAC