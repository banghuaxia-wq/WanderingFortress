...
/// <summary>
/// 管理Pochie的状态UI，包括血条、眩晕条和提示信息，并使其跟随目标在屏幕上移动。
/// </summary>
...
{
    public class PochieStatusUI : MonoBehaviour
    {
        // 默认的自动隐藏延迟时间
        ...
        // 绑定的Pochie战斗控制器
        private PochieCombatController _combatController;
        // 主摄像机
        ...
        /// 初始化UI并将其与一个Pochie绑定。
        /// </summary>
        /// <param name="controller">Pochie的战斗控制器</param>
        public void Initialize(PochieCombatController controller)
        {
            if (controller == null)
            {
                Debug.LogError("传入的PochieCombatController为空！", this);
