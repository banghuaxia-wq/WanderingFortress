...
namespace WF.Gameplay.Systems.ContainerSystem
{
    public class ContainerManager : MonoBehaviour, IContainerManager
    {
        ...
        public void Register(ContainerData data) 
        { 
            if (data == null || string.IsNullOrEmpty(data.Id)) return; 
            _containers[data.Id] = data; 
        }
        
        public ContainerData Get(string id) 
        { 
            if (string.IsNullOrEmpty(id)) return null; 
            _containers.TryGetValue(id, out var d); 
            return d; 
        }
        ...
        public void Open(string id)
        {
            ...
            {
                CurrentOpened = d;
                EventBus.Publish(new ContainerOpenedEvent(d));
            }
        }
        ...
        { 
            ...
            if (d != null) 
            { 
                EventBus.Publish(new ContainerClosedEvent(d)); 
                if (CurrentOpened == d) CurrentOpened = null; 
            } 
        }
