...
/// </summary>
using WF.Gameplay.Systems.Weapons.Gun;
using WF.Gameplay.Systems.Weapons.Bullet;
...
public class PlayerShooter : MonoBehaviour
{
    ...
    private void SpawnBullet(Vector3 direction)
    {
        ...
        {
            bulletInstance = PoolManager.Instance.Get(ammoDefinition.Prefab);
        ...
        {
            payload.AppliedBuffs = new System.Collections.Generic.List<AppliedBuff>
            {
                new AppliedBuff { Buff = ammoDefinition.SedativeBuffData, ExtraValue = delayedStun }
            };
        }
